...
| `mix` | active (local) | 5-node mixnet, per-hop RLN spam protection, membership pre-provisioned **on-chain** — the plugin tree root is asserted to be a valid root of the registry |
