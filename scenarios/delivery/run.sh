...
#      (liblogos_lez_rln_module -> liblogos_rln_module)
...
for n in $NODES_ALL; do
    ...
    daemon_load_modules "$n" liblogos_lez_rln_module \
...
echo "e2e:   modules   liblogos_lez_rln_module liblogos_rln_module delivery_module"
